    ...
    className='bg-slate-50 dark:bg-gray-900 pt-10 sm:pt-10 mt-20 sm:mt-40 px-4 sm:px-10 lg:px-24 xl:px-40'>
      ...
      <div className='flex justify-between lg:items-center max-lg:flex-col gap-10'>
        ...
        className='space-y-5 text-sm text-gray-700 dark:text-gray-400'>
            ...
            <p className='max-w-md'>From strategy to execution, we craft digital solution that move your business forword.</p>
      ...
      className='text-gray-600 dark:text-gray-400'>
        ...
        <p className='text-sm mt-2 mb-6'>The latest news, articals, and resources, send to your inbox weekly.</p>
     ...
     className='pb-6 text-sm text-gray-500 flex justify-center sm:justify-between gap-4 flex-wrap'>
        <p>Copyright 2026 &copy; Maaz Ahmad - All Right Reserved.</p>
